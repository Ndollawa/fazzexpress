...
<div class="x_panel">
<div class="x_title">
<h2><strong>In Transit Items List</strong></h2>
...
<table class="table  table-striped jambo_table table-bordered table-hover" id="datatables">				 
											<div class="text-center" style="margin: 5px 0 5px 70%; display: inline-flex;">
												<select class="form-control text-center" id="bulk-options" name="bulk-options"style="width:200px;margin: 5px 5px;" >
														...
														<option value="Unsuccessful">Unsuccessful Delivery Attempt</option>
													</select>	
											<button type="submit" class="btn btn-sm  btn-round btn-success" id="table-apply-btn" data-action="shipmentBulkOperations" data-callback="all_shipments" name="checkbox-submit" >Apply</button>
																</div>
<thead>
<tr class="headings">
...
<tbody id="intransit_parcelDisTable">
